...
export const readModelDefinitions = Object.freeze([
  ...
  definition({ path: "/read-models/clinical/patients/{patientId}/files", operationId: "listClinicalPatientFilesReadModel", summary: "List patient file review read models", workspace: "clinical", modelKey: "files", allowedRoles: ["doctor"], subjectParam: "patientId" }),
  definition({ path: "/read-models/clinical/patients/{patientId}/reports", operationId: "listClinicalPatientReportsReadModel", summary: "List patient report analysis read models", workspace: "clinical", modelKey: "reports", allowedRoles: ["doctor", "laboratory", "radiology"], subjectParam: "patientId" }),
  definition({ path: "/read-models/clinical/patients/{patientId}/clinical-reasoning", operationId: "listClinicalPatientReasoningReadModel", summary: "List clinician-reviewed clinical reasoning read models", workspace: "clinical", modelKey: "clinical_reasoning", allowedRoles: ["doctor"], subjectParam: "patientId" }),
  definition({ path: "/read-models/clinical/patients/{patientId}/chat", operationId: "listClinicalPatientChatReadModel", summary: "List patient-scoped clinical assistant review read models", workspace: "clinical", modelKey: "patient_chat", allowedRoles: ["doctor"], subjectParam: "patientId" }),
  definition({ path: "/read-models/clinical/chat", operationId: "listClinicalGlobalChatReadModel", summary: "List global clinical assistant review read models", workspace: "clinical", modelKey: "global_chat", allowedRoles: ["doctor", "administrator"] }),
  definition({ path: "/read-models/clinical/patients/{patientId}/workflow", operationId: "listClinicalPatientWorkflowReadModel", summary: "List patient workflow action read models", workspace: "clinical", modelKey: "workflow_actions", allowedRoles: ["doctor", "administrator"], subjectParam: "patientId" }),
  ...
  definition({ path: "/read-models/clinical/patients/{patientId}/notifications", operationId: "listClinicalPatientNotificationsReadModel", summary: "List patient operational notification read models", workspace: "clinical", modelKey: "notifications", allowedRoles: ["doctor", "administrator"], subjectParam: "patientId" }),
