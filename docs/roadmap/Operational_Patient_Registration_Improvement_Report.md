...
- Updated read-model projection display fields so the patient list and patient file summary can show the new patient name, file number, and blood type.
...
5. The patient ID and medical record number are generated automatically.
